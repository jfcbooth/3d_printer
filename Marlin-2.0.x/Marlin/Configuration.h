...
#define STRING_CONFIG_H_AUTHOR "(Josh Booth, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3DPP"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 16.52
  #define DEFAULT_bedKi 1.30
  #define DEFAULT_bedKd 140.31
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (5*60) } // z was 2*60
